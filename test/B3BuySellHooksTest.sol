...
contract B3BuySellHooksTest is Test {
    ...
    function test_BuyHookReceivesCorrectBaseBondingAmount_ShouldFail() public {
        ...
        // Should fail because hook isn't called
        assertEq(buyHook.lastBaseBondingToken(), expectedAmount, "Hook should receive correct base bonding token amount");
    }
    ...
    function test_BuyHookReceivesCorrectBaseInputAmount_ShouldFail() public {
        ...
        // Should fail because hook isn't called
        assertEq(buyHook.lastBaseInputToken(), TYPICAL_INPUT_AMOUNT, "Hook should receive correct base input token amount");
    }
    ...
    function test_SellHookReceivesCorrectBaseBondingAmount_ShouldFail() public {
        ...
        // Should fail because hook isn't called
        assertEq(sellHook.lastBaseBondingToken(), bondingTokens, "Hook should receive correct base bonding token amount");
    }
    ...
    function test_SellHookReceivesCorrectBaseInputAmount_ShouldFail() public {
        ...
        // Should fail because hook isn't called
        assertEq(sellHook.lastBaseInputToken(), expectedInputTokens, "Hook should receive correct base input token amount");
    }
