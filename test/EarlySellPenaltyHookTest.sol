...
contract EarlySellPenaltyHookTest is Test {
    ...
    function test_EarlySellPenaltyHookContractDoesNotExist_ShouldFail() public {
        ...
        vm.expectRevert();
        (bool success,) = address(0).call(abi.encodeWithSignature("new EarlySellPenaltyHook()"));
    ...
    function test_IEarlySellPenaltyHookInterfaceCompilation_ShouldFail() public {
        ...
        vm.expectRevert();
        (bool success,) = address(0).call(abi.encodeWithSignature("getBuyerTimestamp(address)", user1));
